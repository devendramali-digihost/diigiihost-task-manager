    ...
    return (
      <React.Fragment>
        <div className="page-content">
          <Container fluid>
            <Breadcrumbs title="UPDATE CLIENT" breadcrumbItems={this.state.breadcrumbItems} />
            <Row>
                <Col xl="12">
                <Card>
                    <CardBody>
                    ...
                    <form className="needs-validation" >
                        ...
                        <Col md="6">
                            <div className="mb-3">
                            <Label className="form-label" htmlFor="validationCustom01">Company Name</Label>
                            <input
                                name="Company Name"
                        ...
                        <Col md="6">
                            <div className="mb-3">
                            <Label className="form-label" htmlFor="validationCustom01">Contact Person</Label>
                            <input
                                name="Contact Person"
                        ...
                        <Col md="6">
                            <div className="mb-3">
                            <Label className="form-label" htmlFor="validationCustom02">Phone</Label>
                            <input
                                name="Phone"
                                placeholder="Phone"
                                type="text"
                        ...
                        <Col md="12">
                            <div className="mb-3">
                            <Label className="form-label" htmlFor="validationCustom02">Notes</Label>
                            <textarea
                                name="Notes"
                                placeholder="Notes"
                                type="text"
